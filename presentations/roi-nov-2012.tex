...
\author{Roger Leigh}
\date{12th November 2012\\University of Dundee}
...
\frame{
  ...
  \item[PhysicalShape] Geometric shape or mask.  A shape is a geometric
...
\subsection{Physical shapes and representations}
...
\item PhysicalShape
  \begin{itemize}
    ...
    \item 2D shapes are described by a 3D shape (0 pixels thick?)
  \end{itemize}
\item Representation
  \begin{itemize}
...
\frame{
  \frametitle{PhysicalShape types: 3D primitives}
  \begin{center}
    \parbox[t]{0.45\textwidth}{
      \begin{itemize}
      \item Geometric forms (without volume)
        \begin{itemize}
        \item Point
        \item Points
        \item Line
        ...
        \item Arc
        \end{itemize}
      \item Geometric forms (with volume)
        \begin{itemize}
        \item Cuboid
        \item Ellipsoid
        \item Cylinder
    ...
    \parbox[t]{0.45\textwidth}{
      ...
      \item pixel data
        ...
        \item GreyMask
        \end{itemize}
      \item transforms and operations
        \begin{itemize}
...
\frame{
  \frametitle{PhysicalShape types: nD primitives}
  \begin{center}
    \begin{itemize}
    \item nD constraints
      \begin{itemize}
...
\frame{
\frametitle{ROI serialisation example: sphere centre and radius}
\begin{center}
\includegraphics[width=\textwidth]{../images/3DspherePVR1.png}
\end{center}
}
...
\toprule
LEN & Count    & uint32      & 72    & Packet length \\ 
\cmidrule{3-5}
SID & PhysicalShapeID  & uint16      & 11       & Ellipsoid  \\
\cmidrule{3-5}
...
\bigskip
Total size: 72 bytes. \\
Packet length includes LEN
\end{center}
}

\subsection{PhysicalShape relationships}

\frame{
  \frametitle{PhysicalShapes and canonical representations}
  \begin{center}
...

{
  ...
  \frame{
    \frametitle{PhysicalShapes and all representations}
  }
}
...
\begin{frame}[fragile]
  \frametitle{PhysicalShapes and transformations can stack}
  \begin{center}
\small
\begin{verbatim}
ROI {
...
\frame{
  \frametitle{Bitmasks and Dimensional Constraints}
  \begin{itemize}
  \item Dimensional constraints reduce to BitMask1D
  \item Permits iteration in nD
  \end{itemize}
  \centering
  \includegraphics[width=0.8\textwidth]{../images/greymap3}
}
...
\frame{
  ...
  \begin{itemize}
    \item Grouping: what is a ``ROI'' cf. ``PhysicalShape'' or group/set of shapes?  What is the boundary between a shape and a ROI?
    \item 3D + (n-3)D vs nD
    ...
    \item PhysicalShape properties: what is currently in the different models?
