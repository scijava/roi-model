# -*- coding: utf-8 -*-
#
# ROI Specification Draft documentation build configuration file, created by
# sphinx-quickstart on Thu Sep 27 13:38:56 2012.
#
...
htmlhelp_basename = 'ROISpecificationDraftdoc'
...
man_pages = [
    ('roi', 'roispecificationdraft', u'ROI Specification Draft Documentation',
     [u'Roger Leigh'], 1)
]
...
texinfo_documents = [
  ('roi', 'ROISpecificationDraft', u'ROI Specification Draft Documentation',
   u'Roger Leigh', 'ROISpecificationDraft', 'One line description of project.',
   'Miscellaneous'),
]
